...
import { 
  ...
  PieChart, Milestone, LogOut, ChevronRight 
} from 'lucide-react';
    ...
    <>
      <nav className="sticky top-0 z-[100] border-b border-zinc-800 bg-black/80 backdrop-blur-xl px-4 md:px-8 py-4">
        <div className="mx-auto flex max-w-7xl items-center justify-between">
          {/* Logo Section - Brand name now visible on all screens */}
          <Link href="/dashboard" className="flex items-center gap-3 group">
            ...
            <h1 className="text-sm md:text-lg font-bold tracking-tighter uppercase block">
              ...
              return (
                <Link 
                  ...
                  className={`flex items-center justify-between p-5 rounded-2xl border transition-all ${
                    isActive ? 'bg-teal-500 border-teal-400 text-black' : 'bg-zinc-900/50 border-zinc-800 text-white'
                  }`}
                >
                  <div className="flex items-center gap-4">
                    <Icon size={20} />
