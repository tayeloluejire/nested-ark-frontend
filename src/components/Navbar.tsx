...
import {
  ...
  PieChart, Milestone, LogOut, ChevronRight, Database,
} from 'lucide-react';
...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="sticky top-0 z-[100] border-b border-zinc-800 bg-black/80 backdrop-blur-xl px-4 md:px-8 py-4">
        <div className="mx-auto flex max-w-7xl items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            {user && (
              <span className="hidden lg:block text-[10px] text-zinc-600 font-mono uppercase">
                {user.email}
              </span>
            )}
            <button
      ...
      {/* Mobile Menu */}
      <div
        className={`fixed inset-0 z-[90] bg-black transition-transform duration-300 md:hidden ${
