      ...
      <main className="max-w-7xl mx-auto px-6 py-12">
        ...
        <header className="mb-12 border-l-2 border-teal-500 pl-6">
          ...
          <p className="text-zinc-500 text-sm mt-1">
            Infrastructure Management OS — Live System Overview
          </p>
        </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {(user.role === 'GOVERNMENT' || user.role === 'ADMIN') && (
            <button
              ...
              className="p-6 rounded-2xl border border-zinc-800 bg-zinc-900/30 hover:border-teal-500/50 transition-all text-left group"
            >
              <ShieldCheck className="text-teal-500 mb-4" size={24} />
              <h3 className="font-bold uppercase tracking-tight mb-1">Verify Projects</h3>
              <p className="text-zinc-500 text-xs">Review and approve infrastructure proposals.</p>
            </button>
          )}
          ...
          {user.role === 'CONTRACTOR' && (
            ...
            >
              ...
              <h3 className="font-bold uppercase tracking-tight mb-1">Submit Bids</h3>
          ...
          <button
            ...
            className="p-6 rounded-2xl border border-zinc-800 bg-zinc-900/30 hover:border-teal-500/50 transition-all text-left"
          >
          ...
          <button
            ...
            className="p-6 rounded-2xl border border-zinc-800 bg-zinc-900/30 hover:border-teal-500/50 transition-all text-left"
          >
            <Users className="text-teal-500 mb-4" size={24} />
